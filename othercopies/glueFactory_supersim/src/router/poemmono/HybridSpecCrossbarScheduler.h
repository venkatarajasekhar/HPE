 ...
 */
#ifndef ROUTER_POEMMONO_HYBRIDSPECCROSSBARSCHEDULER_H_
#define ROUTER_POEMMONO_HYBRIDSPECCROSSBARSCHEDULER_H_
...
class HybridSpecCrossbarScheduler : public CrossbarScheduler {
 public:
  // constructor and destructor
  HybridSpecCrossbarScheduler(
 ...
 private:
  ...
  struct Pipeline {
    ...
    std::unordered_map<u32, bool> vcs;  // vc -> speculative
  };
  ...
  static const u8 SPECULATE = 1 << 1;  // speculate credit availability
  static const u8 ALLOCATE  = 1 << 2;  // perform allocation, consume credits
...
#endif  // ROUTER_POEMMONO_HYBRIDSPECCROSSBARSCHEDULER_H_
