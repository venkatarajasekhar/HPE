 ...
 */
#ifndef NETWORK_HYPERXPOEMNOC2_DIMORDERROUTINGFUNCTION_H_
#define NETWORK_HYPERXPOEMNOC2_DIMORDERROUTINGFUNCTION_H_
...
#endif  // NETWORK_HYPERXPOEMNOC2_DIMORDERROUTINGFUNCTION_H_
