 ...
 */
#ifndef NETWORK_HIERARCHICALHYPERX_PAR_H_
#define NETWORK_HIERARCHICALHYPERX_PAR_H_
...
class PAR : public GlobalDimOrderRoutingAlgorithm {
 public:
  PAR(const std::string& _name,
...
#endif  // NETWORK_HIERARCHICALHYPERX_PAR_H_
