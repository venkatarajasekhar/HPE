 ...
 */
#ifndef NETWORK_HIERARCHICALHYPERX_GLOBALDIMORDERROUTINGALGORITHM_H_
#define NETWORK_HIERARCHICALHYPERX_GLOBALDIMORDERROUTINGALGORITHM_H_
...
class GlobalDimOrderRoutingAlgorithm : public RoutingAlgorithm {
 public:
  GlobalDimOrderRoutingAlgorithm(const std::string& _name,
  ...
  ~GlobalDimOrderRoutingAlgorithm();
...
#endif  // NETWORK_HIERARCHICALHYPERX_GLOBALDIMORDERROUTINGALGORITHM_H_
