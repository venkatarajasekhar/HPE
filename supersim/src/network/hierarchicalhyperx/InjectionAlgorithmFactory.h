 ...
 */
#ifndef NETWORK_HIERARCHICALHYPERX_INJECTIONALGORITHMFACTORY_H_
#define NETWORK_HIERARCHICALHYPERX_INJECTIONALGORITHMFACTORY_H_
...
#endif  // NETWORK_HIERARCHICALHYPERX_INJECTIONALGORITHMFACTORY_H_
