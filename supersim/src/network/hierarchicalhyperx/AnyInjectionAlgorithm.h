 ...
 */
#ifndef NETWORK_HIERARCHICALHYPERX_ANYINJECTIONALGORITHM_H_
#define NETWORK_HIERARCHICALHYPERX_ANYINJECTIONALGORITHM_H_
...
#endif  // NETWORK_HIERARCHICALHYPERX_ANYINJECTIONALGORITHM_H_
