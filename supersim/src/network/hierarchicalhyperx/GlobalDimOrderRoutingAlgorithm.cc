...
void GlobalDimOrderRoutingAlgorithm::processRequest(
...
std::unordered_set<u32> GlobalDimOrderRoutingAlgorithm::routing(Flit* _flit,
  const std::vector<u32>* destinationAddress) {
  // ex: [1,...,m,1,...,n]
...
u32 GlobalDimOrderRoutingAlgorithm::getPortBase() {
  u32 localDimensions = localDimWidths_.size();
  u32 portBase = concentration_;
...
void GlobalDimOrderRoutingAlgorithm::globalPortToLocalAddress(u32 globalPort,
