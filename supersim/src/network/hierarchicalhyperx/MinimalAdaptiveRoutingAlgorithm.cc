...
u32 MinimalAdaptiveRoutingAlgorithm::getPortBase() {
  u32 localDimensions = localDimWidths_.size();
...
void MinimalAdaptiveRoutingAlgorithm::globalPortToLocalAddress(u32 globalPort,
...
void MinimalAdaptiveRoutingAlgorithm::setLocalDst(
