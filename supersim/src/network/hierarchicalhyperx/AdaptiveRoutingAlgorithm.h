 ...
 */
#ifndef NETWORK_HIERARCHICALHYPERX_ADAPTIVEROUTINGALGORITHM_H_
#define NETWORK_HIERARCHICALHYPERX_ADAPTIVEROUTINGALGORITHM_H_
...
class AdaptiveRoutingAlgorithm : public RoutingAlgorithm {
 public:
  AdaptiveRoutingAlgorithm(const std::string& _name,
...
#endif  // NETWORK_HIERARCHICALHYPERX_ADAPTIVEROUTINGALGORITHM_H_
