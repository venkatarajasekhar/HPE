 ...
 */
#ifndef ROUTER_POEMMONO_POSTSPECCROSSBARSCHEDULER_H_
#define ROUTER_POEMMONO_POSTSPECCROSSBARSCHEDULER_H_
...
class PostSpecCrossbarScheduler : public CrossbarScheduler {
 public:
  // constructor and destructor
  PostSpecCrossbarScheduler(
...
#endif  // ROUTER_POEMMONO_POSTSPECCROSSBARSCHEDULER_H_
