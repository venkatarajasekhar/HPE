 ...
 */
#ifndef NETWORK_HYPERXPOEMNOC2_ROUTINGFUNCTIONFACTORY_H_
#define NETWORK_HYPERXPOEMNOC2_ROUTINGFUNCTIONFACTORY_H_
...
#endif  // NETWORK_HYPERXPOEMNOC2_ROUTINGFUNCTIONFACTORY_H_
